...
echo $from
echo $to
/opt/cloudant-performancecollector/resources/collect/scripts/clientdata_minute_collect.sh $1 $from $to $4
/opt/cloudant-performancecollector/resources/export/postgres/scripts/onetime/clientdata_minute_load.sh $1 $from $to
