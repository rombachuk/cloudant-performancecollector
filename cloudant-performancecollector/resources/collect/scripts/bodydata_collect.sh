...
/opt/cloudant-performancecollector/venv/bin/python /opt/cloudant-performancecollector/bodydata_collect.py -O csv -s $1 -g $2 -f $3 -t $4 -L $5 -H $HOSTNAME -x $conninfo
