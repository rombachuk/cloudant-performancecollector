...
/opt/cloudant-performancecollector/venv/bin/python3 /opt/cloudant-performancecollector/clientdata_collect.py -O csv -s $1 -g minute -f $2 -t $3 -L $4 -H $HOSTNAME -x $conninfo
