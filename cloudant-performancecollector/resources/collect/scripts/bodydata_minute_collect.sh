...
/opt/cloudant-performancecollector/venv/bin/python3 /opt/cloudant-performancecollector/bodydata_collect.py -O csv -s body -g minute -f $1 -t $2 -L $3 -H $HOSTNAME -x $conninfo
